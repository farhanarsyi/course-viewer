/* ============================================================
   KelasFullstack Course Viewer ΓÇö app.js
   ============================================================ */
...
// ΓöÇΓöÇ Card accent colors (cycling) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
const CARD_ACCENTS = [
...
// ΓöÇΓöÇ Roadmap Groups (for roadmap view & sidebar) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
const ROADMAP_GROUPS = [
  { id: 'g-foundation',  label: 'Foundation & Setup',       emoji: '≡ƒº▒', color: '#7c3aed', slugs: ['panduan-member','intro-to-programming','algoritma','text-editor','terminal','cmd','git-pemula','git-dasar'] },
  { id: 'g-design',     label: 'UI/UX Design',              emoji: '≡ƒÄ¿', color: '#db2777', slugs: ['figma','uiux','developer-desain'] },
  { id: 'g-fe-basic',   label: 'Frontend Basics',           emoji: '≡ƒîÉ', color: '#2563eb', slugs: ['dasar-html','dasar-css','belajar-bootstrap-css-framework','kelas-javascript','oop-di-javascript','javascript-asynchronous','javascript-dom','ajax','jquery','bootstrap-4'] },
  { id: 'g-css-fw',     label: 'CSS Frameworks',            emoji: '≡ƒÆà', color: '#0891b2', slugs: ['tailwind','sass','landing-page','ewallet','crowd-funding','portofolio-menggunakan-tailwind'] },
  { id: 'g-vue',        label: 'Vue.js & Nuxt',             emoji: '≡ƒÆÜ', color: '#059669', slugs: ['vue','nuxt','alpine','astro'] },
  { id: 'g-react',      label: 'React.js & Next',           emoji: 'ΓÜ¢∩╕Å', color: '#0284c7', slugs: ['react','nextjs'] },
  { id: 'g-php',        label: 'PHP & MySQL',               emoji: '≡ƒÉÿ', color: '#7c3aed', slugs: ['php','mysql','pengenalan-database','berorientasi-objek'] },
  { id: 'g-laravel',    label: 'Laravel & CodeIgniter',     emoji: '≡ƒö┤', color: '#dc2626', slugs: ['laravel','codeigniter','filament','security-for-developer'] },
  { id: 'g-nodejs',     label: 'Node.js & Backend',         emoji: '≡ƒƒ⌐', color: '#16a34a', slugs: ['nodejs','expressjs','express','mongodb','nestjs','adonis','fullstack-tutorial','implementasi','manajemen','belajar-restful','belajar-konsep-auth','directory-listing','event-management','belajar-dasar-expressjs','belajar-mongodb'] },
  { id: 'g-testing',   label: 'Testing',                   emoji: '≡ƒº¬', color: '#d97706', slugs: ['selenium'] },
  { id: 'g-devops',    label: 'DevOps & Deployment',       emoji: '≡ƒÜÇ', color: '#0f766e', slugs: ['vps','nginx','shared-hosting','netlify','deploy','firebase-hosting','github-pages','vercel','cli-di-linux','revolusi-deployment','devops'] },
  { id: 'g-career',    label: 'Karir & Soft Skills',       emoji: '≡ƒÆ╝', color: '#4f46e5', slugs: ['kode-etik','personal-branding','dunia-kerja','strategi-karir','freelance','english','interview','live-class','english-for-developer','belajar-interview','belajar-freelance','berbagi-ilmu','membangun-personal'] },
];
...
// ΓöÇΓöÇ Roadmap Categories ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
const CATEGORIES = [
  { id: 'all',          label: 'Semua Kursus',       emoji: '≡ƒùé∩╕Å'  },
  { id: 'fundamental',  label: 'Fundamental',         emoji: '≡ƒôÜ'  },
  { id: 'design',       label: 'Design & Figma',      emoji: '≡ƒÄ¿'  },
  { id: 'html-css',     label: 'HTML & CSS',          emoji: '≡ƒîÉ'  },
  { id: 'javascript',   label: 'JavaScript',          emoji: 'ΓÜí'  },
  { id: 'css-framework',label: 'CSS Framework',       emoji: '≡ƒÆà'  },
  { id: 'vue',          label: 'Vue.js',              emoji: '≡ƒÆÜ'  },
  { id: 'react',        label: 'React & Others',      emoji: 'ΓÜ¢∩╕Å'  },
  { id: 'php-mysql',    label: 'PHP & MySQL',         emoji: '≡ƒÉÿ'  },
  { id: 'laravel',      label: 'Laravel & CI',        emoji: '≡ƒö┤'  },
  { id: 'nodejs',       label: 'Node.js & Backend',   emoji: '≡ƒƒó'  },
  { id: 'deployment',   label: 'Deployment & VPS',    emoji: '≡ƒÜÇ'  },
  { id: 'career',       label: 'Career & DevOps',     emoji: '≡ƒÆ╝'  },
];
...
// Lines/phrases that are scraper navigation artifacts ΓÇö strip them out
const SCRAPER_NOISE = [
  /^Kelas Saya$/,
  /^Selanjutnya$/,
  /^Materi$/,
...
function formatText(raw = '') {
  ...
  if (!text) return '';   // nothing to show ΓÇö caller decides whether to render the block
  return text
    .split(/\n\n+/)
    .map(para => {
      const p = para.trim();
...
// ΓöÇΓöÇ DOM refs ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ Show/Hide Views ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ Sidebar toggle ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ Render Sidebar Nav ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ Render Home ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
function renderHome() {
  // Stats
  ...
  // ΓöÇΓöÇ Category filter chips ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  ...
  // ΓöÇΓöÇ Course grid ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
  const grid = $('course-grid');
  grid.innerHTML = '';
  state.courses.forEach((course, idx) => {
    ...
    card.innerHTML = `
      ...
      <div class="card-body">
        <div class="card-number">KURSUS ${idx + 1} ΓÇó ${escapeHtml(CATEGORIES.find(c=>c.id===catId)?.label||'')}</div>
        ...
        <div class="card-footer">
          <div class="card-pills">
            ...
            ${hasVideo ? '<span class="card-pill">≡ƒÄ¼ Video</span>' : ''}
            ${mentorsHtml}
          </div>
...
// ΓöÇΓöÇ Go to Course ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
function renderCourse(course, idx) {
  ...
  // ΓöÇΓöÇ About Section ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
      ...
      li.innerHTML = `
        ...
        <div class="lesson-info">
          ...
          <div class="lesson-badges">
            ${hasYt ? `<span class="lesson-badge yt">Γû╢ YouTube</span>` : ''}
            ${hasVid ? `<span class="lesson-badge video">≡ƒÄ¼ Video</span>` : ''}
            ${hasText ? `<span class="lesson-badge text">≡ƒô¥ Teks</span>` : ''}
          </div>
        </div>
...
// ΓöÇΓöÇ Go to Lesson ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
function renderLesson() {
  ...
  if (formattedText) {
    ...
    // No real text ΓÇö only show if there's also no video
...
// ΓöÇΓöÇ Breadcrumb ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
function updateBreadcrumb(view) {
  ...
  if (view === 'course' || view === 'lesson') {
    ...
    html += `<span class="breadcrumb-sep">ΓÇ║</span><span class="breadcrumb-course" id="bc-course">${escapeHtml(course.course_title)}</span>`;
  }
  if (view === 'lesson') {
    const { lesson } = state.currentLessonFlat[state.currentLessonFlatIdx];
    html += `<span class="breadcrumb-sep">ΓÇ║</span><span class="breadcrumb-lesson">${escapeHtml(lesson.title)}</span>`;
  }
...
// ΓöÇΓöÇ Render Roadmap View ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
      ...
      card.innerHTML = `
        ...
        <div class="rm-card-body">
          ...
          <div class="rm-card-meta">
            ${totalL ? `<span>≡ƒôû ${totalL}</span>` : ''}
            ${hasVideo ? '<span>≡ƒÄ¼ Video</span>' : ''}
            ${course.mentors?.length ? `<span>≡ƒæñ ${escapeHtml(course.mentors[0])}</span>` : ''}
          </div>
        </div>
      `;
      card.addEventListener('click', () => goToCourse(idx));
...
// ΓöÇΓöÇ Keyboard shortcuts ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ Render Quiz ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇ Init ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
function init() {
